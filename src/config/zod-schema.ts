      ...
      .object({
          ...
          .object({
            ...
            baseUrl: z
              ...
              .refine(
                ...
                { message: "baseUrl must be a valid HTTP/HTTPS URL or empty" },
              )
              .optional(),
            token: z.string().optional(),
            timeoutMs: z.number().int().positive().optional(),
        ...
        contentAudit: z
          .object({
            ...
            labelConfigs: z
              .object({
                normal: z.object({ action: z.enum(["allow", "confirm", "block"]) }).strict().optional(),
                porn: z.object({ action: z.enum(["allow", "confirm", "block"]) }).strict().optional(),
                politics: z.object({ action: z.enum(["allow", "confirm", "block"]) }).strict().optional(),
                violence: z.object({ action: z.enum(["allow", "confirm", "block"]) }).strict().optional(),
                illegal: z.object({ action: z.enum(["allow", "confirm", "block"]) }).strict().optional(),
                discrimination: z.object({ action: z.enum(["allow", "confirm", "block"]) }).strict().optional(),
                unethical: z.object({ action: z.enum(["allow", "confirm", "block"]) }).strict().optional(),
              })
              .strict()
              .optional(),
          })
