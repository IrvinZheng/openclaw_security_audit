...
import { clearAgentRunContext, onAgentEvent, registerGatewayBroadcast, unregisterGatewayBroadcast } from "../infra/agent-events.js";
...
export async function startGatewayServer(
  ...
  // Register gateway broadcast for cross-module event broadcasting (e.g., content audit approvals)
  registerGatewayBroadcast(broadcast);
